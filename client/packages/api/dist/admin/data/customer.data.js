...
const customer_type_1 = __importDefault(require("../services/customer/customer.type"));
const loadCustomers = () => {
    return class_transformer_1.plainToClass(customer_type_1.default, [
        {
            id: "1",
            name: "James L. Frank",
        ...
        },
        {
            ...
            image: "https://tinyfac.es/data/avatars/26CFEFB3-21C8-49FC-8C19-8E6A62B6D2E0-200w.jpeg",
        ...
        },
        {
            ...
            image: "https://tinyfac.es/data/avatars/E0B4CAB3-F491-4322-BEF2-208B46748D4A-200w.jpeg",
