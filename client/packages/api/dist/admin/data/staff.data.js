...
const staff_type_1 = __importDefault(require("../services/staff/staff.type"));
const loadStaffs = () => {
    return class_transformer_1.plainToClass(staff_type_1.default, [
        {
            id: '1',
            first_name: 'James',
            last_name: 'Frank',
...
exports.default = loadStaffs;
//# sourceMappingURL=staff.data.js.map