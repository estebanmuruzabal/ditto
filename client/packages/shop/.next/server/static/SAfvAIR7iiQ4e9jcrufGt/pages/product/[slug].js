...
/******/ 			var chunk = require("../../../../" + ({}[chunkId]||chunkId) + "." + {"19":"6547c4c197cb77061b16","20":"8e616dcecd43ec516088","21":"86c41476e1e64e98d9df","23":"91678e830fdbeb667fbf","24":"bc7e699d5e3dc24baacf","25":"1adffae066c43e4f6f0c","26":"e271cfb2e300e1584de1","28":"0db697497e5874530467","29":"29baf778f2d39f469e57","32":"0f975e0dcce5abcf0415"}[chunkId] + ".js");
...
})(["padding:78px 0 60px 0;position:relative;background-color:", ";@media (min-width:1600px){padding-top:89px;}@media (max-width:990px){padding-top:60px;}"], Object(theme_get_["themeGet"])('colors.gray.200', '#f7f7f7'));
...
const ProductDetails = dynamic_default()(() => __webpack_require__.e(/* import() */ 19).then(__webpack_require__.bind(null, "amd9")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("amd9")],
    modules: ['components/product-details/product-details-one/product-details-one']
  }
});
const ProductDetailsBook = dynamic_default()(() => __webpack_require__.e(/* import() */ 20).then(__webpack_require__.bind(null, "3yRL")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("3yRL")],
    modules: ['components/product-details/product-details-two/product-details-two']
  }
});
const CartPopUp = dynamic_default()(() => __webpack_require__.e(/* import() */ 21).then(__webpack_require__.bind(null, "gZAk")), {
  ssr: false,
  loadableGenerated: {
...
const ProductPage = ({
  ...
  }), __jsx(reuse_modal_["Modal"], null, __jsx(product_single_style, null, __jsx(ProductSingleContainer, {
    style: {
      marginTop: "50px"
    }
  }, content))));
