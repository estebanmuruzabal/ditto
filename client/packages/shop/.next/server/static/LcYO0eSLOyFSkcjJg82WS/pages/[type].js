...
/******/ 			var chunk = require("../../../" + ({}[chunkId]||chunkId) + "." + {"21":"ff10f100ce39f9f1adc0","24":"51dbdca96b8d2e576403","26":"5528a7b2354ec3b1eb10","27":"fe80f271e5c7292caed5","29":"f26252372ae98a366986"}[chunkId] + ".js");
...
})(["width:100%;display:flex;flex-wrap:wrap;background-color:", ";padding-right:0;transition:padding-right 0.35s ease-in-out;"], Object(theme_get_["themeGet"])('colors.white', '#ffffff'));
...
})(["display:flex;flex-wrap:wrap;margin-top:30px;background-color:", ";@media (max-width:768px){margin-left:-7.5px;margin-right:-7.5px;margin-top:15px;}"], Object(theme_get_["themeGet"])('colors.white', '#ffffff'));
...
const Sidebar = dynamic_default()(() => __webpack_require__.e(/* import() */ 21).then(__webpack_require__.bind(null, "8XX/")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("8XX/")],
    modules: ['layouts/sidebar/sidebar']
  }
});
const Products = dynamic_default()(() => __webpack_require__.e(/* import() */ 29).then(__webpack_require__.bind(null, "SZ6D")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("SZ6D")],
    modules: ['components/product-grid/product-list/product-list']
  }
});
const CartPopUp = dynamic_default()(() => __webpack_require__.e(/* import() */ 26).then(__webpack_require__.bind(null, "gZAk")), {
  ssr: false,
  loadableGenerated: {
...
const CategoryPage = ({
  ...
  })), _type_jsx(MainContentArea, null, _type_jsx(SidebarSection, null, _type_jsx(Sidebar, {
    type: PAGE_TYPE,
    deviceType: deviceType
