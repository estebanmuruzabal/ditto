...
const MobileDrawer = () => {
  ...
  return mobile_drawer_jsx(drawer, {
    ...
    defaultMessage: "join"
  })))), mobile_drawer_jsx(header_style["c" /* DrawerMenu */], null, isAuthenticated && site_navigation["a" /* AUTHORIZED_MENU_ITEMS */].map((item, idx) => mobile_drawer_jsx(header_style["d" /* DrawerMenuItem */], {
    key: item.id
  ...
  }))), site_navigation["m" /* MOBILE_DRAWER_MENU */].map(item => mobile_drawer_jsx(header_style["d" /* DrawerMenuItem */], {
    key: item.id
  }, mobile_drawer_jsx(nav_link["a" /* default */], {
    onClick: toggleHandler,
    href: item.href,
...
const MobileHeader = ({
  ...
  return mobile_header_jsx(header_style["l" /* MobileHeaderWrapper */], null, mobile_header_jsx(header_style["k" /* MobileHeaderInnerWrapper */], {
    ...
    alt: "shop logo"
  })), mobile_header_jsx(language_switcher["a" /* default */], null), isHomePage ? mobile_header_jsx(header_style["o" /* SearchWrapper */], {
    onClick: handleSearchModal,
    className: "searchIconWrapper"
  }, mobile_header_jsx(SearchIcon["a" /* SearchIcon */], null)) : null));
};
