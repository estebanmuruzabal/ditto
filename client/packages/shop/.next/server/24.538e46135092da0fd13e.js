...
// CONCATENATED MODULE: ./src/utils/useDeviceType.ts

function useDeviceType(userAgent) {
  const md = new external_mobile_detect_default.a(userAgent);
  let mobile = false,
      tablet = false,
      desktop = false;
...
const ProductCard = (_ref) => {
  ...
  const handleAddClick = e => {
    ...
    const currentQuantity = (_getItem = getItem(data.id)) === null || _getItem === void 0 ? void 0 : _getItem.quantity;
  ...
  return __jsx(product_card_style["h" /* ProductCardWrapper */], {
    onClick: onClick,
    className: "product-card"
  }, __jsx(product_card_style["i" /* ProductImageWrapper */], null, __jsx(image_image["a" /* default */], {
    url: image,
  ...
  }))) : ''), __jsx(product_card_style["j" /* ProductInfo */], null, __jsx("h3", {
  ...
  }, currency, salePrice ? salePrice : price)), data.product_quantity != 0 ? !isInCart(data.id) ? __jsx(button_button["a" /* Button */], {
    className: "cart-button",
    variant: "secondary",
    borderRadius: 100,
    onClick: handleAddClick
  }, __jsx(CartIcon["a" /* CartIcon */], null), __jsx(product_card_style["e" /* ButtonText */], null, __jsx(external_react_intl_["FormattedMessage"], {
    id: "addCartButton",
    defaultMessage: "Cart"
    ...
    disabled: true
  }, !desktop && __jsx(CartIcon["a" /* CartIcon */], null), __jsx(product_card_style["e" /* ButtonText */], null, __jsx(external_react_intl_["FormattedMessage"], {
    id: "addCartButton",
    defaultMessage: "Cart"
  })))), showProductQuantityExceededMsg && __jsx(product_card_style["l" /* ProductQuantityExceededMsg */], null, __jsx(external_react_intl_["FormattedMessage"], {
...
})(["font-family:", ";font-size:", "px;font-weight:", ";color:", ";display:block;width:100%;padding:5px 0;text-align:center;"], Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('fonts.body', 'Lato'), Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('fontSizes.base', '12'), Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('fontWeights.bold', '700'), Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('colors.red', '#ea4d4a'));
...
})(["padding-left:15px;@media (max-width:767px){display:none;}"]);
