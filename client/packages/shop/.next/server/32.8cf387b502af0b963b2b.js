...
const MobileDrawer = () => {
  ...
  const menuItems = isGrower ? site_navigation["i" /* GROWER_MENU_ITEMS */] : isStaff ? site_navigation["s" /* STAFF_MENU_ITEMS */] : isAuthenticated ? site_navigation["a" /* AUTHORIZED_MENU_ITEMS */] : [];
...
const MobileHeader = ({
  ...
  })), isHomePage ? mobile_header_jsx(header_style["o" /* SearchWrapper */], {
    onClick: handleSearchModal,
    className: "searchIconWrapper"
  }, mobile_header_jsx(SearchIcon["a" /* SearchIcon */], null)) : null, mobile_header_jsx(header_style["o" /* SearchWrapper */], {
    onClick: handleSearchModal,
    className: "searchIconWrapper"
