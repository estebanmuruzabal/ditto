...
const ProductCard = (_ref) => {
  ...
  return __jsx(product_card_style["h" /* ProductCardWrapper */], {
    ...
    alt: title
  }), discountInPercent ? __jsx(external_react_default.a.Fragment, null, __jsx(product_card_style["f" /* DiscountPercent */], null, discountInPercent, "%")) : '', data.product_quantity == 0 ? __jsx(external_react_default.a.Fragment, null, __jsx(product_card_style["g" /* OutOfStock */], null, "Out Of Stock")) : ''), __jsx(product_card_style["j" /* ProductInfo */], null, __jsx("h3", {
