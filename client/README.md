...
For getting started with the template you have to follow the below procedure. First navigate to the `Ditto` directory. Then run below command for getting started with specific part.
