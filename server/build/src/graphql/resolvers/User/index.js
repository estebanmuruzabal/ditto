...
exports.usersResolvers = {
    ...
    Mutation: {
        ...
        login: (_root, { phone, password }, { db }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const validatePass = yield validatePassword(password, userResult.password);
            if (!validatePass) {
        ...
        changePassword: (_root, { id, old_password, new_password, confirm_password }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const validatePass = yield validatePassword(old_password, userResult.password);
            if (!validatePass || new_password != confirm_password) {
                throw new Error("Password dose not match.");
            }
            yield db.users.updateOne({ _id: new mongodb_1.ObjectId(id) }, { $set: { password: yield hashPassword(new_password) } });
            return {
                status: true,
