...
export const typeDefs = gql`
    ...
    type Mutation {
        ...
        updatePlant(id: ID!, controllerId: Int!, soilHumidity: Int, airHumidity: Int, tempeture: Int, isRelayOneOn: String, isRelayTwoOn: String, isRelayThirdOn: String, isRelayFourthOn: String): DefaultMessageType!
